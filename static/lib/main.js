$(function() {
	...
	! function(n, e, i, a) {
		n.navigation = function(t, s) {
			...
			u.settings = {};
			var t = (n(t), t);
			n(t).find(".nav-menus-wrapper").prepend("<span class='nav-menus-wrapper-close-button'>âœ•</span>"), n(t).find(".nav-search").length > 0 && n(t).find(".nav-search").find("form").prepend("<span class='nav-search-close-button'>Ã¢Å“â€¢</span>"), u.init = function() {
