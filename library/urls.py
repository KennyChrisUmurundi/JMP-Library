...
urlpatterns = [
    ...
    path(
        "update_library/<int:pk>",
        views.UpdateLibrary.as_view(),
        name="update_library",
    ),
    ...
    path(
        "update_catalog/<int:pk>/",
        views.UpdateCatalog.as_view(),
        name="update_catalog",
    ),
    path(
        "delete_catalog/<int:id>/", views.DeleteCatalog, name="delete_catalog"
    ),
    # EBOOKS
    ...
    path(
        "update_member/<int:pk>/",
        views.UpdateMember.as_view(),
        name="update_member",
    ),
    ...
    path(
        "update_supplier/<int:pk>/",
        views.UpdateSupplier.as_view(),
        name="update_supplier",
    ),
    path(
        "delete_supplier/<int:id>/",
        views.DeleteSupplier,
    ...
    path(
        "delete_purchase/<int:id>/",
        views.DeletePurchase,
    ...
    path(
        "add_designation/<int:pk>/",
        views.add_designation,
        name="add_designation",
    ),
    path(
        "update_designation/<int:pk>/",
        views.UpdateDesignation.as_view(),
        name="update_designation",
    ),
    path(
        "delete_designation/<int:id>/",
        views.DeleteDesignation,
        name="delete_designation",
    ),
    # Department
    path("department/<int:pk>", views.department, name="department"),
    path(
        "add_department/<int:pk>/", views.add_department, name="add_department"
    ),
    path(
        "update_department/<int:pk>/",
    ...
    path(
        "process_subscription/<plan>/<int:pk>",
        views.process_subscription,
